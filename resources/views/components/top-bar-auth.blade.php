        ...
        <div class="absolute hidden mt-2 w-auto rounded-md shadow-lg bg-white focus:outline" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1" id="menu-items">
            <div class="pt-1" role="none">
                ...
                <form method="POST" action="{{ Route('logout') }}" role="none">
                    @csrf
                    <button type="submit" class="block w-full text-left px-4 rounded-b-md py-2 text-sm text-gray-700 hover:bg-red-400 bg-red-300" role="menuitem" tabindex="-1" id="menu-item-3">Sign out</button>
                </form>
            </div>
        </div>
    </div>
